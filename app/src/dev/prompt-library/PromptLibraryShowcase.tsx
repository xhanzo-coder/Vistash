...
const prompts: PromptRow[] = Array.from({ length: 10_000 }, (_, index) => ({
  ...
  tags: index % 3 === 0 ? ["电影感"] : [],
  linked_image_hashes: index % 7 === 0 ? [IMAGE_HASH] : [],
  cover_image_hash: null,
  resolved_cover_hash: index % 7 === 0 ? IMAGE_HASH : null,
...
mockIPC((command, payload) => {
  ...
  if (command === "linked_image_states") return [{ hash: IMAGE_HASH, deleted: false, display_filename: "电影光影参考.png", folder: "构图", width: 1024, height: 1024 }];
